...
with tf.Session() as sess:
    ...
    for epoch in range(numTrainingIters):
        ...
        if epoch >= (numTrainingIters - 10):
            lossLast10.append(_totalLoss)
            correctLast10.append(numCorrect)

lossAve10 = sum(lossLast10) / 10
correctAve10 = sum(correctLast10) / (batchSize * 10) * 100
print('Average loss for the last 10 mini-batches is ', lossAve10, ', average correct labels is ', correctAve10, ' out of 100')
